...
return [
    ...
    'backup' => [
        ...
        'source' => [
            'files' => [
                 ...
                 */
                'include' => [
                    // Kode ada di Git; yang dicadangkan hanya file unggahan (foto, brosur, pricelist).
                 ...
                 */
                'exclude' => [
                    // Varian AVIF/WebP bisa dibuat ulang: php artisan images:variants.
                    storage_path('app/public/_variants'),
                ],
    ...
    'notifications' => [
        'notifications' => [
            ...
            // Hanya kirim email kalau ada masalah.
